...
$secpasswd = ConvertTo-SecureString “dhtWFetlMc,ZQV^/.!+L1” -AsPlainText -Force 
$O365Cred = New-Object System.Management.Automation.PSCredential (“svc-powershell@kontoorbrands.onmicrosoft.com”, $secpasswd)
